<template>
    ...
    <div v-else class="filter-wrapper wwm3" v-show="facets && facets.length > 0">

        <a class="btn btn-link filter-toggle" data-toggle="collapse" :href="'#filter-collapse_' + _cid" aria-expanded="false" :aria-controls="'filter-collapse_' + _cid">
            <i class="fa fa-sliders default-float" aria-hidden="true"></i> {{ $translate("Ceres::Template.itemFilter") }}
        </a>

        <div class="filter-collapse collapse" :id="'filter-collapse_' + _cid">
        ...
        {{ $translate("Ceres::Template.itemFilter") }}
            ...
            <div class="container-max page-content component-loading" :class="{ 'is-loading': isLoading }">
                ...
                <div class="row">
                    <div class="col-12 text-right d-lg-none mx-0 px-0">
