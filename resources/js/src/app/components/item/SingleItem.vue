<template>
    <div>
        <slot :getDataField="getDataField" :getFilteredDataField="getFilteredDataField">
            <div class="single container-max page-content wwm6">
                <div class="row position-relative">
123321
                    <div class="col-12 col-md-6 mt-5">
                        <slot name="image-carousel"></slot>
                            <div class="single-swiper-hinweis mt-2"> Abb. kann vom Original abweichen. </div>
                    </div>
                    ...
                    <div class="col-12 col-md-12">
                        ...
                        <div class="my-5">
                            ...
                            <div class="tab-content overflow-hidden">
                                ...
                                <div :class="{ 'active': !isDescriptionTabActive && !isTechnicalDataTabActive }" class="tab-pane overflow-auto" id="propertyGroup" role="tabpanel">
                                    <div class="my-4">
                                        <table class="table table-striped table-hover table-sm">
                                            <tbody>
                                            ...
                                            <template v-for="(variationPropertyGroups, index) in $store.getters.currentItemVariation.variationProperties">
                                              ...
                                              <tr class="propertyWrap" v-if="variationProperty.values.value !== ''">
