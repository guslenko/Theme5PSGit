<template>
    <div>
        ...
        <div class="d-inline" v-if="showQuantity && !useLargeScale" :class="{'d-none': !$ceres.isItemView }">
        ...
        <div class="d-inline" v-if="!showQuantity && !useLargeScale" :class="{'d-none': !isWishList }">
            ...
            else if (this.isSalable || this.isSet)
            {
                ...
                this.$store.dispatch("addBasketItem", basketObject).then(
                    response =>
                    {
                        ...
                        console.log(1); 
                        document.dispatchEvent(new CustomEvent("AfterBasketChanged", { detail: basketObject }));
                    },
                    error =>
                    {
                        this.$store.commit("setIsAddToBasketLoading", 0);
